function [vector_mse] = generate_all_vector(filepath, codes, vector_len, q_method, destination, method_name, do_generate_plots, do_generate_audio)
%GENERATE_Q_SIGNAL
%   Argumenty:
...
for n = codes
    ...
    for i = 1:2
        ...
        [sygnal_wyjsciowy(:, i), mse(i)] = q_method(sygnal_kanal, n, vector_len);
    ...
    if do_generate_audio
        filename = destination + "/" + vector_len + "-" + nazwa_pliku + n + ".wav"
